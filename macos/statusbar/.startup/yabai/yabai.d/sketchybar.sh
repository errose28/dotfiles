...
sketchybar-yabai-set-height
# Refresh bar when yabai is restarted.
sketchybar-yabai-reload

# Refresh bar when mission control is entered/exited.
yabai -m signal --add event=mission_control_enter action='sketchybar-mission-control-enter'  label=sketchybar-mc-enter
...
# Refresh bar when minimized windows change.
yabai -m signal --add event=window_minimized action='sketchybar-yabai-reload' label=sketchybar-windw-created
yabai -m signal --add event=window_deminimized action='sketchybar-yabai-reload' label=sketchybar-windw-destroyed
